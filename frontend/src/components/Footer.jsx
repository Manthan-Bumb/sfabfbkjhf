      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 grid grid-cols-2 md:grid-cols-4 gap-8 text-sm">
        <div>
          <div className="flex items-center gap-2">
            <img src="https://customer-assets.emergentagent.com/job_cargo-hub-134/artifacts/pnh7dk3f_Untitled%20design.png" alt="LogScanner" className="h-10 w-10 object-cover rounded-sm" />
